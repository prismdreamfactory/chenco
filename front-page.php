        ...
        <div class="front">
            <div class="front-hero">
                <div class="front-hero-content">
                    ...
                    <a class="front-button">Learn More</a>
                </div>
            </div>
            ...
            <div class="front-project">
                ...
                <span class="front-line"></span>
                <h1>Reno Daybreak: Addressing the "Missing Middle" With A New, Inspired, And Attainable Master Planned Community.</h1>
                <a class="front-button" href="https://www.google.com">Learn More</a>
            </div>
        </div>
