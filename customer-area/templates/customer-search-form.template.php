...
<div class="form-group">
  ...
  <div class="control-container">
    <select name="cuar_post_type" id="cuar_post_type" class="form-control">
      <option value="any" <?php selected('any', $this->criteria['post_type']); ?>><?php _e('Any type', 'cuarse'); ?>
      </option>
...
<div class="form-group">
  ...
  <div class="control-container">
    <select name="cuar_sort_order" id="cuar_sort_order" class="form-control">
      <option value="ASC" <?php selected('ASC', $this->criteria['sort_order']); ?>><?php _e('Ascending', 'cuarse'); ?>
      </option>
      <option value="DESC" <?php selected('DESC', $this->criteria['sort_order']); ?>>
        <?php _e('Descending', 'cuarse'); ?></option>
    </select>
  </div>
</div>
