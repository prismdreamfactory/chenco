    ...
    <div class="panel-heading">
      ...
      <div class="widget-menu pull-right">
        <div class="btn btn-default btn-sm cuar-js-download-all">
          <span class="cuar-js-btn-caption"><span
              class="fa fa-download"></span>&nbsp;<?php _e('Download all attachments', 'cuar'); ?></span>
          <div class="progress cuar-js-download-progress"
            style="margin: 0; min-width: 140px; text-align: center; display: none;">
            <div class="progress-bar progress-bar-default cuar-js-progress-bar" role="progressbar" aria-valuenow="0"
  ...
  $('.cuar-js-download-all').click(function(event) {
    ...
    php foreach($attachments as $file_id => $file): ? >
      zip.file(
        '<?php echo $file['
        file ']; ?>',
        urlToPromise('<?php cuar_the_attached_file_link($post->ID, $file, '
          download '); ?>'), {
          binary: true
        }); <
    ?
